...
export const KEYBOARD_SHORTCUTS = {
  playback: [
    ...
    { keys: ['ê'], description: 'Skip back 5s' },
    { keys: ['í'], description: 'Skip forward 5s' },
    { keys: ['Shift', 'ê'], description: 'Skip back 10s' },
    { keys: ['Shift', 'í'], description: 'Skip forward 10s' },
  ],
  stems: [
  ...
  speed: [
    { keys: ['S'], description: 'Cycle speed (70% í 85% í 100%)' },
  ],
  loop: [
